...
const EQUIPE=[
  ['SUBLET',    100,100, 1961, {noExempt:1}],   // 66 ans en 2027 mais prend 100 % des gardes (décision Arthur 31/07/2026)
...
function buildRoster(year,{ageExempt=60,ageRetraite=67}={}){
  ...
  EQUIPE.forEach(([id,pct,q,born,f0])=>{
    ...
    // MERCIER (né 1967) y entre en 2027 : décision d'Arthur, il n'en prend plus.
