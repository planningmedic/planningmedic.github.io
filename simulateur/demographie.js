...
function buildAbsences(year,roster,scen,opts){
  ...
  roster.forEach(([id,pct,q,f],idx)=>{
    ...
    /* ── FORMATION / CONGRÈS — LE QUOTA ENTIER (01/09/2026).
       ...
       quota de 10). Arbitrage du responsable : on simule le cas où TOUT est posé
    ...
    /* ── VACANCES HORS CALENDRIER SCOLAIRE (01/09/2026).
       ...
       ne ressemble pas au service. Arbitrage du responsable : trois quarts en période
    ...
    // Réalité (le responsable) : chacun dispose d'un POOL proportionnel à sa quotité,
