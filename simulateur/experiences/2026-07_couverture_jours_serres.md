...
**Objectif du responsable : il ne doit JAMAIS y avoir de jour sans binôme.**
...
contre 3,4 pour le moteur d'origine (MAR15, 2041 : 2 week-ends pour une cible
de 7,3). Le dépôt a été restauré, puis la passe réécrite. le responsable n'avait rien
...
364 jours, ~2 000 jours d'absence), souhaits de 3 MAR sur les mardis — dont MAR01
...
Usage réel confirmé par le responsable : les jours de temps partiel sont **dispersés**,
parfois groupés sur une semaine ; le seul rythme fixe du service est MAR17
