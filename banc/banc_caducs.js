...
{
  const fantomes = [
    { mois: 'Janvier 2027', marId: 'MAR08', date: '2027-01-04', statut: 'F' },
    { mois: 'Janvier 2027', marId: 'MAR18', date: '2027-01-07', statut: 'RG' },
    { mois: 'Juin 2026', marId: 'MAR08', date: '2026-06-25', statut: 'RG' },
  ];
  ...
  const r2 = fusionner(fantomes, 'Juin 2026', [{ marId: 'MAR02', date: '2026-06-30', statut: 'RG' }]);
  V('publier un mois AVEC conflits remplace tout son lot', r2.filter(x => x.mois === 'Juin 2026').length === 1
    && r2.some(x => x.marId === 'MAR02') && !r2.some(x => x.date === '2026-06-25'), r2);
  V('les nouvelles entrées portent bien le mois publié', r2.find(x => x.marId === 'MAR02').mois === 'Juin 2026');
...
console.log('\n═══ F2. Le tri : seul l\'avenir avertit ═══');
{
  ...
  const r = trier([
    { marId: 'MAR08', date: '2026-06-25', statut: 'RG' },       // passé
    { marId: 'MAR22', date: '2026-08-28', statut: 'F' },     // futur
    { marId: 'DURAND', date: '2026-08-24', statut: 'CP' },     // aujourd'hui
    { marId: 'MAR18', date: '2027-01-07', statut: 'RG' },      // futur lointain
  ], auj);
