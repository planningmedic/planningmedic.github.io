...
(async () => {
  ...
  console.log('\n═══ 28j. Les cibles d\'équité voyagent par la copie rapide ═══');
  {
    ...
    // (15/09/2026) l'action est la fonction _act_getStatsLive (fichier métier) ; la table du routeur la déclare « tout code valide »
    const bloc = require('./stubs').blocAction('getStatsLive');
  ...
  /* ═══ 28d. LA MÉMOIRE DU CODE D'ACCÈS (17/08/2026) ═══
     ...
     Choix du responsable : 30 jours glissants, MAIS seulement dans l'app installée —
