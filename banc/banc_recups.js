...
console.log('\n═══ 4. Charge RÉELLE du service — le test qui compte ═══');
{
  /* `jeu_service.json` reprend INDISPOS_2027 du classeur au 21/08/2026 : le scénario
     de démonstration construit par le responsable, calqué sur le volume et la saisonnalité
  ...
  if (!r.error) {
    ...
    /* Le plancher d'effectif est ABSOLU — décision du responsable : « on ne passe pas sous
