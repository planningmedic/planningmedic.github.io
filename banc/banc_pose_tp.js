...
console.log('\n═══ PT12 · éligibilité SANS nom en dur : plein temps, jours fixes, rythme 2/2 ═══');
{
  ...
  V('jours fixes déclarés → aucun jour posé (MAR04 s\'exclut par sa colonne)',
...
{
  const b = monde({});
  vm.runInContext("_tpFermerJour_(2027, '2027-03-02', 'MAR01')", b.ctx);
  vm.runInContext("_tpFermerJour_(2027, '2027-03-02', 'MAR01')", b.ctx);   // idempotent
...
console.log('\n═══ PT23 · le bloc comité d\'admin : effectif de l\'INSTANT ═══');
{
  ...
  bacA.TPC = { presents: { '2027-03-23': 15, '2027-04-02': 15 },
    demandes: [
      { id: 'MAR06', jour: '2027-03-23', etat: null },
      { id: 'MAR05', jour: '2027-03-23', etat: null },
      { id: 'MAR15', jour: '2027-04-02', etat: null }] };
  ...
  V('MAR06 validé → la ligne de MAR05 se recalcule : 13 (le point de la maquette)', psi(1) === 13, psi(1));
...
{
  /* (23/08/2026) Décision du responsable : validation ET refus se notifient au MAR
