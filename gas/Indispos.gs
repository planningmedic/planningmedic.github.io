...
// déclarés — MAR04 — ou rythme 2 semaines sur 2 — même règle que getVacConfig.)
...
/* (19/08/2026) Écrit la grille complète des affectations dans l'onglet.
   ...
   sans ligne existante (fiche créée après l'onglet — MAR01 2026, MAR10)
  ...
  try {
    ...
    if (action === 'login') {
      ...
      return ContentService.createTextOutput(JSON.stringify({
        ...
        // jours fixes (MAR04) et rythme 2/2 s'excluent par leurs colonnes MEDECINS.
        phaseTp: _phaseTp_(),
...
// puis l'année la plus ancienne. Exclut no_garde et MAR01 (souhait_plafond),
...
function computeNoelAnEligibles(year, tous) {
  ...
  // Effectif éligible : actifs − no_garde − MAR01 − hors année
