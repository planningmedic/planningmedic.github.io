...
/* ── L'INTERRUPTEUR (13/08/2026 — décision le responsable) ─────────────────────
...
/* (14/08/2026) Un humain lit ces messages : « Dr Durand », pas « DURAND ».
   ...
   MAR01, qui est Pr et non Dr. Mise en forme d'AFFICHAGE seule : les noms
...
function _echangesDr_(id) {
  ...
  if (!brut) return '';
  const titre = brut.toUpperCase() === 'MAR01' ? 'Pr ' : 'Dr ';
